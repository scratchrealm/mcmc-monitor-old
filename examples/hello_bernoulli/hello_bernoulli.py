...
from mcmc_monitor import load_workspace, monitor_stan_run, TemporaryDirectory
...
def main():
    ...
    with TemporaryDirectory() as tmpdir:
      ...
      # allow monitoring to finish before removing directory (need to think of a better way)
      time.sleep(2)
